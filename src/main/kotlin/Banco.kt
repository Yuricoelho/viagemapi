...
import conta.investimento.ContaInvestimento
import conta.poupanca.ContaPoupanca
import kotlin.random.Random

class Banco {
    var contasCorrente = mutableListOf<ContaCorrente>()
    var contasInvestimento: MutableList<ContaInvestimento> = mutableListOf()
    var contasPoupanca: MutableList<ContaPoupanca> = mutableListOf()
    val geradorDeNumerosRandomicos = Random(4645)

    fun abrirContaCorrente(nome: String, cpf: String, endereco: String): ContaCorrente {
